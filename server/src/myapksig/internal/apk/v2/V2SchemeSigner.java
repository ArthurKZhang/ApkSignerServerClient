...
package myapksig.internal.apk.v2;
...
import static myapksig.internal.apk.ApkSigningBlockUtils.*;
...
public abstract class V2SchemeSigner {
    ...
    public static Pair<byte[], Integer> generateApkSignatureSchemeV2Block(
        ...
        Pair<List<SignerConfig>, Map<ContentDigestAlgorithm, byte[]>> digestInfo =
                ApkSigningBlockUtils.computeContentDigests(                        //remind v2 开始计算摘要
     ...
     * 创建 v2 签名块
     * @param signerConfigs
     * @param contentDigests
     * @param v3SigningEnabled
     * @return
    ...
    private static byte[] generateSignerBlock(
        ...
        PublicKey publicKey = signerConfig.certificates.get(0).getPublicKey(); //remind v2签名块--证书里的公钥
        ...
        signer.signedData = encodeAsSequenceOfLengthPrefixedElements(new byte[][] {
            encodeAsSequenceOfLengthPrefixedPairsOfIntAndLengthPrefixedBytes(signedData.digests),       //remind  v2 签名块 signeData--包含摘要
            encodeAsSequenceOfLengthPrefixedElements(signedData.certificates),                          //remind  v2 签名块 signeData--包含证书
            signedData.additionalAttributes,                                                            //remind  v2 签名块 signeData--包含算法
            new byte[0],
        });
        ...
        return encodeAsSequenceOfLengthPrefixedElements(
                new byte[][] {
                    ...
                    encodeAsSequenceOfLengthPrefixedPairsOfIntAndLengthPrefixedBytes(
                            signer.signatures),                                                 //remind  v2 签名块 签名
                    signer.publicKey,                                                           //remind  v2 签名块 公钥
                });
    }
