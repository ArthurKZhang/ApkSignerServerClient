...
package myapksig.internal.apk;

import myapksig.ApkVerifier;
...
import myapksig.internal.asn1.Asn1BerParser;
import myapksig.internal.asn1.Asn1DecodingException;
...
import myapksig.internal.util.ChainedDataSource;
import myapksig.internal.util.Pair;
import myapksig.internal.util.VerityTreeBuilder;
import myapksig.internal.x509.RSAPublicKey;
import myapksig.internal.x509.SubjectPublicKeyInfo;
...
public class ApkSigningBlockUtils {
    ...
    public static Pair<List<SignerConfig>, Map<ContentDigestAlgorithm, byte[]>>
        ...
        try {
            contentDigests =
                    computeContentDigests(         //remind v2/v3 摘要--对Apk内容进行摘要  需要传入计算摘要的算法，该算法需要根据pubkey得到
                            executor,
                            contentDigestAlgorithms,
                            beforeCentralDir,
                            centralDir,
